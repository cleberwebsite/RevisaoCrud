...
public class UserDao extends Dao {
	...
	private final String INSERT = "INSERT INTO user (produto, categoria) values (?,?)";
	private final String UPDATE = "UPDATE user SET produto = ?,  categoria = ? WHERE id = ?";
	...
	private void inserir(User user) throws Exception {
		try {
			...
			ps.setString(1, user.getProduto());
