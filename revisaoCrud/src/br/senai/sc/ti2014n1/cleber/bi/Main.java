...
//		excluir();
	...
	private static void editar() {
		...
		user.setProduto(user.getProduto().concat(" A."));
		try {
			userRn.salvar(user);
	...
	private static void mostrar(User user) {
		System.out.println("Nome: " + user.getProduto());
		System.out.println("E-mail: " + user.getCategoria());
		System.out.println("------------------------------");
	}

	private static void inserirUm() {
		User user = new User();
		user.setProduto("Maria");
		user.setCategoria("maria@email.com");
